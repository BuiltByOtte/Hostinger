...
<head>
    ...
    @endif
    @isset($title)
    <meta content="{{ isset($title) ? config('app.name', 'hostinger') . ' - ' . $title : config('app.name', 'hostinger') }}" property="og:title">
    <meta content="{{ isset($title) ? config('app.name', 'hostinger') . ' - ' . $title : config('app.name', 'hostinger') }}" name="title">
    @endisset
    @isset($description)
