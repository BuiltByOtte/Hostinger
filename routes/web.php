...
use App\Livewire\CustomPages\Show as CustomPagesShow;
...
// Custom Pages fallback route
Route::fallback(CustomPagesShow::class)->middleware('web')->name('custom-pages.show');
