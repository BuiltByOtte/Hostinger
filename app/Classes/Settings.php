        ...
        $settings = [
            ...
            'social-login' => [
                [
                    ...
                    'description' => new HtmlString('<a href="https://Hostinger.org/docs/guides/OAuth#google" target="_blank">Documentation</a>'),
                    'type' => 'checkbox',
                ...
                [
                    ...
                    'description' => new HtmlString('<a href="https://Hostinger.org/docs/guides/OAuth#github" target="_blank">Documentation</a>'),
                    'type' => 'checkbox',
                    'database_type' => 'boolean',
                    'default' => false,
                    'required' => false,
                ...
                [
                    ...
                    'description' => new HtmlString('<a href="https://Hostinger.org/docs/guides/OAuth#discord" target="_blank">Documentation</a>'),
                    'type' => 'checkbox',
                    'database_type' => 'boolean',
                    'default' => false,
                    'required' => false,
