...
{
    protected const DEFAULT_URL = 'https://github.com/Hostinger/Hostinger/releases/%s/Hostinger.tar.gz';
    ...
    public function handle()
    {
        ...
        // Call update.sh <url>
        $this->line('$upgrader> curl -L "https://raw.githubusercontent.com/Hostinger/Hostinger/master/update.sh" | bash -s -- --user=' . $user . ' --group=' . $group . ' --url=' . $this->getUrl());
        $process = Process::fromShellCommandline('curl -L "https://raw.githubusercontent.com/Hostinger/Hostinger/master/update.sh" | bash -s -- --user=' . $user . ' --group=' . $group . ' --url=' . $this->getUrl(), null, null, null, 1200);
