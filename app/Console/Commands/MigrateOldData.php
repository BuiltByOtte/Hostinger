...
class MigrateOldData extends Command
{
     ...
     * @var string
     */
    protected $description = 'Migrates all the data from Hostinger version 0.x to 1.x';
    ...
    public function handle()
    {
        ...
        $username = $this->askOrUseENV(argument: 'username', env: 'DB_USERNAME', question: 'Enter the username:', placeholder: 'Hostinger');
