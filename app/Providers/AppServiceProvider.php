...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        Request::macro('livewireUrl', function () {
            if (request()->route()->named('hostinger.livewire.update')) {
        ...
        Request::macro('livewireRoute', function () {
            ...
            if (request()->route()->named('hostinger.livewire.update')) {
                ...
                return 'hostinger.livewire.update';
            }
    ...
    public function boot(): void
    {
        ...
        Livewire::setUpdateRoute(function ($handle) {
            return Route::post('/hostinger/update', $handle)->middleware('web')->name('hostinger.');
        });
