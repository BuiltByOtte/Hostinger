...
namespace Hostinger\\Extensions\\Servers\Pterodactyl;
    ...
    public function getProductConfig($values = []): array
    {
        ...
        return [
            ...
            [
                ...
                'hint' => new HtmlString('<a href="https://hostinger.org/docs/extensions/pterodactyl#port-array" target="_blank">Documentation</a>'),
                'live' => true,
                'validation' => 'json',
            ],
            [
